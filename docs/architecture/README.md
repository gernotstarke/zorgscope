# zorgscope – Architecture documentation (arc42)

Structured after the [arc42 template](https://arc42.org). Chapters that only reference requirements
stay short on purpose — the requirements are the source of truth.

| # | Chapter | Content |
|---|---------|---------|
| 1 | [Introduction and goals](01-introduction-and-goals.md) | requirements overview, quality goals, stakeholders |
| 2 | [Constraints](02-constraints.md) | link to requirements C‑x, technical consequences |
...
| 12 | [Glossary](12-glossary.md) | link |

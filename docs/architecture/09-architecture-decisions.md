...
| ADR | Title | Status |
|-----|-------|--------|
| [ADR‑0001](decisions/ADR-0001-web-app-instead-of-wails.md) | Web application instead of a Wails desktop app | accepted |
...
| [ADR‑0003](decisions/ADR-0003-server-rendered-ui-htmx.md) | Server‑rendered UI with html/template, htmx and hand‑written CSS | accepted |
| [ADR‑0004](decisions/ADR-0004-sqlite-persistence.md) | SQLite via pure‑Go driver as the only persistence | accepted |
...
| [ADR‑0006](decisions/ADR-0006-passkey-authentication.md) | Passkey‑only single‑user authentication with enrolment token | accepted |
| [ADR‑0007](decisions/ADR-0007-config-yaml-secrets-env.md) | YAML configuration in the repository, secrets via environment | accepted |
